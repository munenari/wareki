...
var (
	...
	Eras = map[eraID]Era{
		"meiji":  {ShortName: "M", KanjiName: "明治", StartedAt: time.Date(1868, 10, 23, 0, 0, 0, 0, locJST)}, //明治: 1868-10-23
		"taisho": {ShortName: "T", KanjiName: "大正", StartedAt: time.Date(1912, 7, 30, 0, 0, 0, 0, locJST)},  //大正: 1912-07-30
		"showa":  {ShortName: "S", KanjiName: "昭和", StartedAt: time.Date(1926, 12, 25, 0, 0, 0, 0, locJST)}, //昭和: 1926-12-25
		"heisei": {ShortName: "H", KanjiName: "平成", StartedAt: time.Date(1989, 1, 8, 0, 0, 0, 0, locJST)},   //平成: 1989-01-08
		"reiwa":  {ShortName: "R", KanjiName: "令和", StartedAt: time.Date(2019, 5, 1, 0, 0, 0, 0, locJST)},   //令和: 2019-05-01
	}
